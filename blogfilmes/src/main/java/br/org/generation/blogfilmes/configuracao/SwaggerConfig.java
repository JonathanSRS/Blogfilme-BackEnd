package br.org.generation.blogfilmes.configuracao;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("br.org.generation.blogfilmes.controller"))
	...
	private static Contact contact() {
		...
		return new Contact("Jonathan da Silva",
				"https://github.com/JonathanSRS",
				"jonathansilvadevjpldv@gmail.com");
	}
	...
	private static List<Response> responseMessageForGET(){
		return new ArrayList<Response>() {
			...
			
			{
				...
				.description("Não Autorzado!").build());
