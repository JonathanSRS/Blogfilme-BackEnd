...
public class UsuarioControllerTeste {
	...
	@BeforeAll
	public void start() {
		//usuario = new Usuario(0L, "Administrador", "admin@email.com.br", "admin123");
		//usuario = new Usuario(0L, "Fred Flintstone", "fred@bedrock.com", "65897100");
		usuarioAtualize = new Usuario(1L, "Pedritta Flintstone", "novoadmin@admin.com", "admin3456");
	}
	...
	public void realizarDeleteUsuarios() {
		ResponseEntity<String> resposta = testRestTemplate.exchange("/usuarios/1", HttpMethod.DELETE, null, String.class);
		assertEquals(HttpStatus.OK, resposta.getStatusCode());
	}
